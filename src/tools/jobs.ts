  ...
  server.registerTool(
    "jobs",
    {
      ...
      inputSchema: {
        ...
        reason: bounded(MAX_TITLE).optional().describe('For fail and block: why. For resume: what the human approved, which is what the audit row records and what the next holder of the job reads as resume_note. For supersede: why the job was replaced or withdrawn.'),
